...
SECRET_KEY = '+)=we381nh0s=3$5k%o1mmiatp*lly1r*8zb-x2z9m@kyxe*+9'
...
ROOT_URLCONF = 'ourcms.urls'



WSGI_APPLICATION = 'ourcms.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'ourcms', 'templates'),],
        'OPTIONS': {
            'context_processors': [
